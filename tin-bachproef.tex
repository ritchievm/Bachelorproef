...
\begin{itemize}
	\item Latency: Dit is de tijdsvertraging die optreed tussen de verzender en ontvanger. Bij VOIP mag dit maximum 150ms zijn. Meer zou ervoor zorgen dat het gesprek wegvalt.
	\item Jitter: Dit is vertraging die veroorzaakt wordt door queue's, datacongestie, routeveranderingen of serialisatie. Vanaf 40ms gaat de kwaliteit van het gesprek bij VOIP achteruit.
	\item Packetloss: Soms komen bepaalde pakketten niet aan op hun bestemming. Dan spreken we van Packet Loss. Voor VOIP kan je  maximum 1% verlies toestaan bij WAN en slechts 0.05% bij LAN.
\end{itemize}
...
Vervolgens wordt duidelijk hoe VOIP andere technologieën kan tegenwerken. Als je in je netwerk gebruikmaakt van zaken die zelf ook veel bandwith gebruiken. Dan kan een veeleisend VOIP met deze technologieën gaan vechten. Op deze manier leiden beide hieronder en gaan de werking van beiden achteruit. 
